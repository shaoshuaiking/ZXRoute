...
@implementation ZXBusNavigator

+(ZXBusNavigator *)navigator{
    static ZXBusNavigator *rootNavigator = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        if (rootNavigator == nil) {
            rootNavigator = [[ZXBusNavigator alloc] init];
        }
    });
...
@implementation ZXBusNavigator (HookRouteBlock)

//
//  ZXBusMediatorTipViewController.m
//  ZXRoute
//
...
@interface ZXBusMediatorTipViewController()
...
@implementation ZXBusMediatorTipViewController
...
+(nonnull UIViewController *)paramsErrorTipController{
    ZXBusMediatorTipViewController *controller = [[ZXBusMediatorTipViewController alloc] init];
